...
func ClusterNotificationsListSMTPEndpoints(c *pve.Client) (res []struct {
...
func ClusterNotificationsNewSMTPEndpoint(c *pve.Client, req ClusterNotificationsNewSMTPEndpointRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/notifications/endpoints/smtp",
...
func ClusterNotificationsGetSMTPEndpoint(c *pve.Client, name string) (res struct {
	FromAddress string   `json:"from-address"`
	Name        string   `json:"name"`
	Server      string   `json:"server"`
	Author      *string  `json:"author"`
...
//
//	Check: ["and",["perm","/mapping/notifications",["Mapping.Modify"]],["or",["perm","/",["Sys.Audit","Sys.Modify"]],["perm","/",["Sys.AccessNetwork"]]]]
func ClusterNotificationsUpdateSMTPEndpoint(c *pve.Client, req ClusterNotificationsUpdateSMTPEndpointRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/notifications/endpoints/smtp/{name}",
...
//
//	Check: ["or",["perm","/mapping/notifications",["Mapping.Modify"]],["perm","/mapping/notifications",["Mapping.Audit"]]]
func ClusterNotificationsDeleteSMTPEndpoint(c *pve.Client, name string) (err error) {
	req := struct {
		Name string `in:"path=name;nonzero"`
	}{
		Name: name,
