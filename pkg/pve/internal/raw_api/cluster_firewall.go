...
func ClusterFirewallGetRefs(c *pve.Client, req ClusterFirewallGetRefsRequest) (res []struct {
...
//
//	Check: ["perm","/",["Sys.Audit"]]
func ClusterFirewallGetOptions(c *pve.Client) (res struct {
...
func ClusterFirewallPutOptions(c *pve.Client, req ClusterFirewallPutOptionsRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/firewall/options",
...
func ClusterFirewallGetMacros(c *pve.Client) (res []struct {
