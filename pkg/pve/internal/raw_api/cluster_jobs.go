...
func ClusterJobsScheduleList(c *pve.Client, req ClusterJobsScheduleListRequest) (res []struct {
...
func ClusterJobsListRealmSync(c *pve.Client) (res []ClusterJobsGetRealmSyncResponse, err error) {
	err = c.Do(pve.Request{
...
func ClusterJobsGetRealmSync(c *pve.Client, id string) (res ClusterJobsGetRealmSyncResponse, err error) {
	req := struct {
...
//	     'Realm.AllocateUser' on '/access/realm/<realm>' and 'User.Modify' permissions to '/access/groups/'.
//		Check: ["and",["perm","/access/realm/{realm}",["Realm.AllocateUser"]],["perm","/access/groups",["User.Modify"]]]
func ClusterJobsPostRealmSync(c *pve.Client, req ClusterJobsPostRealmSyncRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/jobs/realm-sync",
...
//	'Realm.AllocateUser' on '/access/realm/<realm>' and 'User.Modify' permissions to '/access/groups/'.
//	Check: ["and",["perm","/access/realm/{realm}",["Realm.AllocateUser"]],["perm","/access/groups",["User.Modify"]]]
func ClusterJobsPutRealmSync(c *pve.Client, req ClusterJobsPutRealmSyncRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/jobs/realm-sync/{id}",
...
func ClusterJobsDeleteRealmSync(c *pve.Client, id string) (err error) {
	req := struct {
