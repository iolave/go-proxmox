...
func ClusterNotificationsListSendmailEndpoints(c *pve.Client) (res []struct {
...
func ClusterNotificationsNewSendmailEndpoint(c *pve.Client, req ClusterNotificationsNewSendmailEndpointRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/notifications/endpoints/sendmail",
...
func ClusterNotificationsGetSendmailEndpoint(c *pve.Client, name string) (res struct {
	Name        string   `json:"name"`
	Author      *string  `json:"author"`
	Comment     string   `json:"comment"`
...
//
//	Check: ["and",["perm","/mapping/notifications",["Mapping.Modify"]],["or",["perm","/",["Sys.Audit","Sys.Modify"]],["perm","/",["Sys.AccessNetwork"]]]]
func ClusterNotificationsUpdateSendmailEndpoint(c *pve.Client, req ClusterNotificationsUpdateSendmailEndpointRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/notifications/endpoints/sendmail/{name}",
...
//
//	Check: ["or",["perm","/mapping/notifications",["Mapping.Modify"]],["perm","/mapping/notifications",["Mapping.Audit"]]]
func ClusterNotificationsDeleteSendmailEndpoint(c *pve.Client, name string) (err error) {
	req := struct {
		Name string `in:"path=name;nonzero"`
	}{
		Name: name,
