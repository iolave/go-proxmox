...
func ClusterSDNVNetsList(c *pve.Client, pending, running int) (res []ClusterSDNVNet, err error) {
	req := struct {
...
func ClusterSDNVNetsNewVNet(c *pve.Client, req ClusterSDNVNetsNewVNetRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/sdn/vnets",
...
func ClusterSDNVNetsGetVNet(c *pve.Client, id string) (res ClusterSDNVNet, err error) {
	req := struct {
...
func ClusterSDNVNetsUpdateVNet(c *pve.Client, req ClusterSDNVNetsUpdateVNetRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/sdn/vnets/{vnet}",
...
//
//	Require 'SDN.Allocate' permission on '/sdn/zones/<zone>/<vnet>'
func ClusterSDNVNetsDeleteVNet(c *pve.Client, id string) (err error) {
	req := struct {
		VNet string `in:"path=vnet;nonzero"`
	}{
		VNet: id,
...
func ClusterSDNVNetsNewIPMapping(c *pve.Client, req ClusterSDNVNetsNewIPMappingRequest) (err error) {
	err = c.Do(pve.Request{
...
//
//	Check: ["perm","/sdn/zones/{zone}/{vnet}",["SDN.Allocate"]]
func ClusterSDNVNetsUpdateIPMapping(c *pve.Client, req ClusterSDNVNetsUpdateIPMappingRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/sdn/vnets/{vnet}/ips",
		Method:  http.MethodPut,
		Payload: &req,
...
//
//	Check: ["perm","/sdn/zones/{zone}/{vnet}",["SDN.Allocate"]]
func ClusterSDNVNetsDeleteIPMapping(c *pve.Client, id string) (err error) {
	req := struct {
		VNet string `in:"path=vnet;nonzero"`
	}{
		VNet: id,
