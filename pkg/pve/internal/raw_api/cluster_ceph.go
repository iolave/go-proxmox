...
func ClusterCephGetStatus(c *pve.Client) (res any, err error) {
...
//
//	Check: ["perm","/",["Sys.Audit","Datastore.Audit"],"any",1]
func ClusterCephGetMetadata(c *pve.Client, req ClusterCephGetMetadataRequest) (res struct {
...
func ClusterCephFlagsGetAllStatus(c *pve.Client) (res []struct {
...
//
//	Check: ["perm","/",["Sys.Audit"]]
func ClusterCephFlagsGetStatus(c *pve.Client, flag string) (res int, err error) {
	req := struct {
...
func ClusterCephFlagsSetStatus(c *pve.Client, flag string, value int) (err error) {
	req := struct {
		Flag  string `in:"path=flag;nonzero"`
