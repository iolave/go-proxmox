...
func ClusterHAGroupsList(c *pve.Client) (res []struct {
...
func ClusterHAGroupsPost(c *pve.Client, req ClusterHAGroupsPostRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/ha/groups",
...
func ClusterHAGroupsGet(c *pve.Client, group string) (res any, err error) {
	req := struct {
...
//
//	Check: ["perm","/",["Sys.Console"]]
func ClusterHAGroupsUpdate(c *pve.Client, req ClusterHAGroupsUpdateRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/ha/groups/{group}",
...
//
//	Check: ["perm","/",["Sys.Console"]]
func ClusterHAGroupsDelete(c *pve.Client, group string) (err error) {
	req := struct {
		Group string `in:"path=group"`
	}{
		Group: group,
