...
func ClusterFirewallGroupsList(c *pve.Client) (res []struct {
...
func ClusterFirewallGroupsPost(c *pve.Client, req ClusterFirewallGroupsPostRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/firewall/groups",
...
func ClusterFirewallGroupsGet(c *pve.Client, name string) (res []ClusterFirewallGroupsGetResponse, err error) {
	req := struct {
...
//
//	Check: ["perm","/",["Sys.Modify"]]
func ClusterFirewallGroupsNewRule(c *pve.Client, req ClusterFirewallGroupsNewRuleRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/firewall/groups/{group}",
		Method:  http.MethodPost,
		Payload: &req,
...
//
//	Check: ["perm","/",["Sys.Modify"]]
func ClusterFirewallGroupsDelete(c *pve.Client, name string) (err error) {
	req := struct {
		Group string `in:"path=group"`
	}{
		Group: name,
...
//
//	Check: ["perm","/",["Sys.Audit"]]
func ClusterFirewallGroupsGetRule(c *pve.Client, name string, pos int) (res ClusterFirewallGroupsGetResponse, err error) {
	req := struct {
		Group string `in:"path=group"`
		Pos   int    `in:"path=pos"`
	}{
...
//
//	Check: ["perm","/",["Sys.Modify"]]
func ClusterFirewallGroupsUpdateRule(c *pve.Client, req ClusterFirewallGroupsUpdateRuleRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/firewall/groups/{group}/{pos}",
...
//
//	Check: ["perm","/",["Sys.Modify"]]
func ClusterFirewallGroupsDeleteRule(c *pve.Client, name string, pos int) (err error) {
	req := struct {
		Group string `in:"path=group"`
		Pos   int    `in:"path=pos"`
	}{
