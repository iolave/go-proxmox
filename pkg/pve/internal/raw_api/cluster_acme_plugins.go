...
func ClusterACMEGetPlugins(c *pve.Client) (res []ClusterACMEGetPluginResponse, err error) {
...
//
//	Check: ["perm","/",["Sys.Modify"]]
func ClusterACMEGetPlugin(c *pve.Client, id string) (res ClusterACMEGetPluginResponse, err error) {
	req := struct {
		ID string `in:"path=id;nonzero"`
	}{
		ID: id,
...
//
//	Check: ["perm","/",["Sys.Modify"]]
func ClusterACMEPostPlugin(c *pve.Client, req ClusterACMEPostPluginRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/acme/plugins",
...
//
//	Check: ["perm","/",["Sys.Modify"]]
func ClusterACMEDeletePlugin(c *pve.Client, id string) (err error) {
	req := struct {
		ID string `in:"path=id;nonzero"`
	}{
		ID: id,
...
//
//	Check: ["perm","/",["Sys.Modify"]]
func ClusterACMEUpdatePlugin(c *pve.Client, req ClusterACMEUpdatePluginRequest) (err error) {
	err = c.Do(pve.Request{
		Path:    "/api2/json/cluster/acme/plugins/{id}",
